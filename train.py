...
from trainers import crossEntropyLossTrainer, weightedCrossEntropyLossTrainer, diceCrossEntropyLossTrainer, customDiceLossTrainer
...
if __name__ == '__main__':
    ...
    test_data_path = "./data/sent_valid_" + tag + ".csv"

    train_val_df = pd.read_csv(train_data_path)
    test_df = pd.read_csv(test_data_path)

    train_val_df = train_val_df[train_val_df.iloc[:, 0].apply(lambda x: isinstance(x, str))]
    ...
    train_df, val_df = train_test_split(train_val_df, stratify=train_val_df['label'],test_size=0.2, random_state=42)
